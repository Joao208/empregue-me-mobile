...
handlePress2 = ({navigation}) => {() => navigation.navigate('Navigation')}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <Svg height={height +50} width={width} style={{borderRadius:10}}>
            <ClipPath id="clip">
              <Circle r={height + 50} cx={width / 2} />
            </ClipPath>
          <Image
            href={require('../assets/mobile-develop.png')}
            width={width}
            height={height + 50}
        ...
        <View style={{ height: height / 3, justifyContent: 'center' }}>
          ...
          <Animated.View style={{
            ...
            <Text style={{fontSize:20,fontWeight:'bold'}}>SIGN N</Text>
            </TouchableOpacity>
            </Animated.View>
